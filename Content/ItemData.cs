...
public static partial class ItemData
{
    ...
    public static Item BlasterPistol => new()
    {
        ...
        IsWeapon = true,
        Damage = new DiceCode(3),
        AttackSkill = SkillType.Blasters,
        Range = 30,
        Price = 50,
    };
    ...
    public static Item Claws => new()
    {
        Name = "Claws",
        Description = "Beast claws. Not worth much.",
        IsWeapon = true,
        Damage = new DiceCode(4),
        AttackSkill = SkillType.Melee,
        Range = 0,
